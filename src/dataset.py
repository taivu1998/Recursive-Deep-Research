...
class ResearchDataset(Dataset):
    """
    Custom Dataset for loading Evaluation Queries.
    Expects a JSON file. If missing, generates a dummy Golden Set for reproducibility.
    """
    ...
    def _create_dummy_data(self):
        """Generates a Golden Set of 50 hard compositional questions for evaluation."""
